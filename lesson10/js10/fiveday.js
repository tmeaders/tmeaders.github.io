const fivedayURL =
    "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&appid=466dca7cca93940a33882268fd25bd99";
fetch(fivedayURL)
    ...
    .then((fivedayObject) => {
         ...
         */
        const forecast = fivedayObject.list.filter((x) =>
        ...
        for (let day = 0; day < forecast.length; day++) {
            ...
            const imagesrc =
                ...
                ".png";
            /*const imagesrc = `https://openweathermap.org/img/w/${fivedayObject.weather[0].icon}.png`;*/
